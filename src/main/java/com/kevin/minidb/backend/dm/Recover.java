...
import com.kevin.minidb.backend.dm.page.PageX;
...
/**
 * @author Kevin Liu
 * @description 从log恢复数据
 * @create 2024/7/28 12:22
 */
public class Recover {
    ...
    //  update log data 格式[LogType]  [XID] [UID] [OldRaw] [NewRaw]  UID=4字节pgno+4字节 pg offest 但是offset只占低16位
    private static final int OF_TYPE = 0;
    private static final int OF_XID = OF_TYPE+1;
    private static final int OF_UPDATE_UID = OF_XID+8;
    private static final int OF_UPDATE_RAW = OF_UPDATE_UID+8;

    // insert log data[LogType] [XID] [Pgno] [Offset] [Raw]
