...
public class DataManagerTest {
    ...
    public void testDMSingle() throws Exception {
        ...
        DataManager dm0 = DataManager.create("D://TESTDMSingle", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D://TESTDMSingle.db").delete();
        new File("D://TESTDMSingle.log").delete();
    }

    @Test
    public void testDMMulti() throws InterruptedException {
        TransactionManager tm0 = new MockTransactionManager();
        DataManager dm0 = DataManager.create("D://TestDMMulti", PageCache.PAGE_SIZE*10, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        ...
        new File("D://TestDMMulti.db").delete();
        new File("D://TestDMMulti.log").delete();
    }

    @Test
    public void testRecoverySimple() throws InterruptedException {
        TransactionManager tm0 = TransactionManager.create("D://TestRecoverySimple");
        DataManager dm0 = DataManager.create("D://TestRecoverySimple", PageCache.PAGE_SIZE*30, tm0);
        DataManager mdm = MockDataManager.newMockDataManager();
        dm0.close();
        ...
        int workerNums = 10;
        for(int i = 0; i < 8; i ++) {
            dm0 = DataManager.open("D://TestRecoverySimple", PageCache.PAGE_SIZE*10, tm0);
        ...
        new File("D:/TestRecoverySimple.db").delete();
        new File("D://TestRecoverySimple.log").delete();
        new File("D://TestRecoverySimple.xid").delete();
