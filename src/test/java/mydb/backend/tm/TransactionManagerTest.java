...
public class TransactionManagerTest {
    ...
    public void testMultiThread() {
        tmger = TransactionManager.create("D:/tranmger_test");
        ...
        // Ensure resources are closed before deleting the file
        if (tmger instanceof TransactionManagerImpl) {
            ((TransactionManagerImpl) tmger).close();
        }
        assert new File("D:/tranmger_test.xid").delete();
    }
